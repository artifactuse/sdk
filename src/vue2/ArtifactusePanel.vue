<template>
  <div>
    <!-- Panel (using portal-vue for Vue 2) -->
...
export default defineComponent({
  ...
  props: {
    // Use portal-vue for rendering to body
    usePortal: {
      type: Boolean,
      default: true,
    },
  ...
  setup(props, { emit }) {
    ...
    async function handleCopy() {
      ...
      try {
        ...
        textarea.value = activeArtifact.value.code;
